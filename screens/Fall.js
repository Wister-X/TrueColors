...
const seasonConfig = {
  spring: { icon: 'sunny-outline', color: '#FFD700', bgColor: '#FFFACD' },
  summer: { icon: 'cloud-outline', color: '#B0C4DE', bgColor: '#F0F8FF' },
  autumn: { icon: 'leaf-outline', color: '#8B4513', bgColor: '#FFF0E0' },
...
export default function DynamicSelfieResults() {
  ...
  const seasonData = seasonConfig[season.toLowerCase()] || seasonConfig.spring;
